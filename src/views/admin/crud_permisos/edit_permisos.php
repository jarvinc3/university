        ...
        <section id="menu2" class="w-[100%] h-[100vh] bg-[#f5f6fa]">
            ...
            <div class="p-5 h-[80%] flex flex-col gap-6 mt-[70px] ">
                <div class="flex justify-between">
                    <h1 class=" text-2xl font-medium text-gray-700">Editar Permisos</h1>
                ...
                <div class="bg-white shadow-sm shadow-gray-400 w-[30%] rounded-sm flex flex-col justify-center relative left-[40%]">
                    <div class="flex items-center justify-between p-3">
                        <h2>Editar Permisos</h2>
                    </div>
                    <hr>
                    <div class="flex flex-col gap-4 p-3 px-6">
                        <form class="flex flex-col gap-4" method="post" action="#">
                            ...
                            <div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <div class="w-11 h-6 bg-red-500 rounded-full peer-checked:after:translate-x-full  after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-green-600"></div>
                                    <span class="ml-3 text-sm font-medium text-gray-900">Usuario Activo</span>
                                </label>
                            </div>
                            <div class="flex justify-between gap-2">
                                <a href="./permisos.php" class="bg-gray-400 text-white px-4 py-[6px] rounded-md right-5  hover:bg-gray-500 hover:shadow-custom hover:shadow-zinc-800">close</a>
