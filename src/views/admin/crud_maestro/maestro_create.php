        ...
        <section id="menu2" class="w-[100%] h-[100vh] bg-[#f5f6fa] ">
            ...
            <div class="p-5 h-[80%] flex flex-col gap-6 mt-[70px] ">
                ...
                <div class="bg-white shadow-sm shadow-gray-400 w-[100%] rounded-sm  flex flex-col justify-center gap-1">
                    ...
                    <form class="flex flex-col gap-4 p-3 pl-6" action="/src/accions/crud_maestro/crud_create_maestros.php" method="post">
                            <div>
                                <strong>
                            ...
                            <a href="./crud_maestros.php" class="w-[100px] bg-gray-400 text-white px-4 py-[6px] rounded-md right-5  hover:bg-gray-500 hover:shadow-custom hover:shadow-zinc-800">close</a>
                            <button type="submit" class="w-[100px] bg-blue-500 text-white px-4 py-[6px] rounded-md right-5  hover:bg-blue-600 hover:shadow-custom hover:shadow-zinc-800">crear</button>
                        </form>
                    </div>
                </div>
