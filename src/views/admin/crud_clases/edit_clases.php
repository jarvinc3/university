            ...
            <div class="p-5 h-[80%] flex flex-col gap-6 mt-[70px] ">
                ...
                <div class="bg-white shadow-sm shadow-gray-400 w-[40%] rounded-sm flex flex-col justify-center relative left-[35%]">
                    ...
                    <div class="flex flex-col gap-4 py-3 px-6">
                        <form class="flex flex-col gap-4 py-3 px-6" method="post" action="/src/accions/crud_clases/edit_clase.php">
                            <div>
                                <strong>
                                ...
                                <div class="flex items-center border-gray-300 border-2 pr-3 rounded-md  hover:bg-slate-200  hover:shadow-custom hover:shadow-zinc-800">
                                    <input class="px-3 py-[6px] w-[100%] rounded-l-md hover:bg-slate-200 focus:outline-0" type="text" name="clase" value=" <?php echo $resultado2['cursoID']; ?> - <?php echo $resultado2['nombreCurso']; ?>">
                                </div>
                            </div>
